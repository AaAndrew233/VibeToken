...
- 可选只读连接 Sub2API，展示每个账号及账号池的 Codex 5h/7d 剩余额度、账号预计恢复时间，并明确标记限流或不可用账号。
- 原生 macOS 菜单栏与程序坞入口，支持英文和简体中文；程序坞图标可选择常驻或仅保留菜单栏。
...
4. 在时间范围选择器右侧的“程序坞图标”菜单中，选择图标常驻或仅保留菜单栏。
5. 使用语言按钮切换英文或简体中文。
