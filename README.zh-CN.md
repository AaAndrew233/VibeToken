...
> [!NOTE]
> 当前为早期预览版，已支持 22 个 AI 编程数据源。当前版本是 [v0.1.2 Preview](https://github.com/AaAndrew233/VibeToken/releases/tag/v0.1.2)。GitHub Releases 提供可下载安装包，但安装包尚未经过 Apple 公证。
...
- 可选只读连接 Sub2API，展示每个账号及账号池的 Codex 5h/7d 剩余额度、对应套餐到期时间、账号预计恢复时间，并明确标记限流或不可用账号。
- 原生 macOS 菜单栏与程序坞入口，支持英文和简体中文；独立“设置”窗口管理程序坞图标常驻/仅菜单栏和开机自动启动，其他设置仍保留在原有菜单和额度区域。
...
- 当前版本：[v0.1.2 Preview](https://github.com/AaAndrew233/VibeToken/releases/tag/v0.1.2)。
...
4. 点击菜单栏弹窗右上角的齿轮按钮打开“设置”，调整程序坞图标显示方式和开机自动启动；时间范围、语言、刷新方式仍使用原有入口。
